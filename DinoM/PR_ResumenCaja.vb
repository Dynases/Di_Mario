    ...
    Public Sub _prInterpretarDatos(ByRef _dt As DataTable)
        ...
        If (CheckTodosVendedor.Checked And CheckUnaALmacen.Checked) Then
            If (tbAlmacen.SelectedIndex >= 0) Then
                _dt = L_prResumenCobrosTodosVendedorUnaAlmacen(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), tbAlmacen.Value)
            End If
        ...
        If (checkUnaVendedor.Checked And CheckUnaALmacen.Checked) Then
            If (tbAlmacen.SelectedIndex >= 0 And tbCodigoVendedor.Text.Length > 0) Then
                _dt = L_prResumenCobrosUnaVendedorUnaAlmacen(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), tbAlmacen.Value, tbCodigoVendedor.Text)
            End If
    ...
    Private Sub _prCargarReporte()
        ...
        If (_dt.Rows.Count > 0) Then
            If (swTipoVenta.Value = True) Then
                Dim objrep As New R_ResumenCreditoAlmacen
