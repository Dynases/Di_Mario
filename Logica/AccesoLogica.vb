...
#Region "TY004 CLIENTES"
   ...
   Public Shared Function L_fnGrabarCLiente(ByRef _ydnumi As String,
    ...
    Public Shared Function L_fnGrabarCLienteConDetalleZonas(ByRef _ydnumi As String, _ydcod As String, _yddesc As String, _ydnumiVendedor As Integer, _ydzona As Integer, _yddct As Integer, _yddctnum As String, _yddirec As String, _ydtelf1 As String, _ydtelf2 As String, _ydcat As Integer, _ydest As Integer, _ydlat As Double, _ydlongi As Double, _ydobs As String, _ydfnac As String, _ydnomfac As String, _ydtip As Integer, _ydnit As String, _ydfecing As String, _ydultvent As String, _ydimg As String, _detalle As DataTable) As Boolean
        ...
        Return _resultado
    End Function
    Public Shared Function L_fnGrabarCLienteConDetalleZonasMigrar(ByRef _ydnumi As String, _ydcod As Integer, _yddesc As String, _ydnumiVendedor As Integer, _ydzona As Integer, _yddct As Integer, _yddctnum As String, _yddirec As String, _ydtelf1 As String, _ydtelf2 As String, _ydcat As Integer, _ydest As Integer, _ydlat As Double, _ydlongi As Double, _ydobs As String, _ydfnac As String, _ydnomfac As String, _ydtip As Integer, _ydnit As String, _ydfecing As String, _ydultvent As String, _ydimg As String) As Boolean
        Dim _resultado As Boolean
...
#Region "TV001 Ventas"
    ...
    Public Shared Function L_fnListarProductosSinLote(_almacen As String, _cliente As String, _detalle As DataTable) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnListarClientes(_sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnListarClientesUno(_cliente As String) As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@ydcod", _cliente))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TV001", _listParam)
    ...
    Public Shared Function L_fnListarNumiVenta() As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnListarNumiVentaTaidcore() As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnListarEmpleado(_cod As String) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 18))
        _listParam.Add(New Datos.DParametro("@ydcod", _cod))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TV001", _listParam)
...
#Region "COBROS DE LAS VENTAS"
    ...
    Public Shared Function L_fnObtenerVentasByFechasByVendedor(_fechadesde As String, _FechaHasta As String, NumiVendedor As String) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@fechai", _fechadesde))
        _listParam.Add(New Datos.DParametro("@fechaf", _FechaHasta))
        _listParam.Add(New Datos.DParametro("@numivendedor", NumiVendedor))
        _Tabla = D_ProcedimientoConParam("sp_Marco_TV001", _listParam)

        Return _Tabla
    End Function

    Public Shared Function L_fnObtenerVentasByFechasByAlmacen(_fechadesde As String, _FechaHasta As String, Almacen As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnObtenerVentasByFechasByAlmacenVendedor(_fechadesde As String, _FechaHasta As String, Almacen As Integer, NumiVendedor As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "TI002 MOVIMIENTOS "
    ...
    Public Shared Function L_fnStockActualPrincipal() As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
...
#Region "REPORTES VS VENTAS"
    ...
    Public Shared Function L_prResumenCobrosTodosVendedorUnaAlmacen(fechaI As String, fechaF As String, _numiAlmacen As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prVentasVsCostosUnaVendedorUnaAlmacen(fechaI As String, fechaF As String, _numiAlmacen As String, _numiVendedor As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prResumenCobrosUnaVendedorUnaAlmacen(fechaI As String, fechaF As String, _numiAlmacen As String, _numiVendedor As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "REPORTE DE CREDITOS"
    ...
    Public Shared Function L_fnReporteMorosidadTodosAlmacenUnVendedor(numiVendedor As Integer, _fechai As String, _fechaf As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnReporteMorosidadUnAlmacenUnVendedor(numiVendedor As Integer, numialmacen As Integer, _fechai As String, _fechaf As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "REPORTE DE SALDOS DE PRODUCTO AGRUPADOS POR LINEAS"
    ...
    Public Shared Function L_fnReporteClienteAlmacenVendedor() As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prClientesVendedorTodosAlmacen(_numiVendedor As String) As DataTable
    ...
    Public Shared Function L_prClientesUnVendedorUnAlmacen(_numiVendedor As String, _numiAlmacen As String) As DataTable
...
#Region "Migracion Access"
    Public Shared Function L_Ayuda_Vendedor() As DataTable
        Dim _Tabla As DataTable
        _Tabla = Datos.AccesoDatos2.D_Datos_Tabla("ydper, ydnom1", "TY004", " ydven = 1")
        Return _Tabla
    End Function
    Public Shared Function L_ProductosGeneral(_Modo As Integer, Optional _Cadena As String = "") As DataSet
        ...
        Dim _Where As String
        If _Modo = 0 Then
            _Where = " VY005.yfcprod = VY005.yfcprod"
        Else
            _Where = _Cadena
        End If
        _Tabla = Datos.AccesoDatos2.D_Datos_Tabla("yfnumi, yfcprod, yfcbarra, yfcdprod1, yfcdprod2, yfcomp, ycdes3, yfacc, expr1, yfpresen, expr2, yflab, expr3, yfcmed, yfumed, yfumin, yfusup, yfvsup,yfsmin, ylpcostoul, ylpventaul, yfmstk, yfclot, yfap, yfimg", "VY005", _Where + " order by yfnumi")
        _Ds.Tables.Add(_Tabla)
        Return _Ds
    End Function
    Public Shared Function L_PersonasGeneral(_Modo As Integer, Optional _Cadena As String = "") As DataSet
        Dim _Tabla As DataTable
        Dim _Ds As New DataSet
        Dim _Where As String
        If _Modo = 0 Then
            _Where = " VY004.ydper = VY004.ydper"
        Else
            _Where = _Cadena
        End If
        _Tabla = Datos.AccesoDatos2.D_Datos_Tabla("ydper, ydnom1, ydnom2, ydclp, Expr3, ydgr1, ycdes2, ydgr2, Expr1, ydtipd, ycdes1, ydnumd, ydpais, expr4, ydcity, expr5, ydprov, expr6, ydzona, expr7, ydcalle, ycdes3, ydnum, yddirec, ydtelef, ydcelu, ydemail, ydcli, ydpro, ydven, ydscli, ydap", "VY004", _Where + " order by ydper")
        _Ds.Tables.Add(_Tabla)
        Return _Ds
    End Function


    Public Shared Function L_ObtenerPreciosProductoDeAlmacen(ByVal _CodAlmacen As String) As DataTable
        Dim _tabla As DataTable

        Dim _where As String = "b.ylalm = " + _CodAlmacen _
                               + " Union all " _
                               + " SELECT IIf(IsNull(b.ylnumi), 0, b.ylnumi) as ylnumi, a.yfcprod, a.yfcdprod1, " _
                               + " IIf(IsNull(b.ylpvenmay), 0, b.ylpvenmay) as ylpvenmay, IIf(IsNull(b.ylpventaul), 0, b.ylpventaul) " _
                               + " as ylpventaul, IIf(IsNull(b.ylpcostoul), 0, b.ylpcostoul) as ylpcostoul, b.ylpdol " _
                               + " FROM TY005 a left join (Select * From TY0052 where ylalm = " + _CodAlmacen + ") b on a.yfcprod = b.ylcprod " _
                               + " WHERE b.ylcprod is null "

        _tabla = Datos.AccesoDatos2.D_Datos_Tabla("IIf(IsNull(b.ylnumi), 0, b.ylnumi) as ylnumi, a.yfcprod, a.yfcdprod1, " _
                               + "IIf(IsNull(b.ylpvenmay), 0, b.ylpvenmay) as ylpvenmay, IIf(IsNull(b.ylpventaul), 0, b.ylpventaul) " _
                               + "as ylpventaul, IIf(IsNull(b.ylpcostoul), 0, b.ylpcostoul) as ylpcostoul, b.ylpdol ",
                               "TY005 a left join TY0052 b on a.yfcprod = b.ylcprod",
                               _where)

        Return _tabla

        'SELECT IIf(IsNull(b.ylnumi), 0, b.ylnumi) as ylnumi, a.yfcprod, a.yfcdprod1, IIf(IsNull(b.ylpvenmay), 0, b.ylpvenmay) as ylpvenmay, IIf(IsNull(b.ylpventaul), 0, b.ylpventaul) as ylpventaul, IIf(IsNull(b.ylpcostoul), 0, b.ylpcostoul) as ylpcostoul, b.ylpdol 
        'FROM TY005 a left join TY0052 b on a.yfcprod = b.ylcprod 
        'WHERE b.ylalm = 3

        'Union all

        'SELECT IIf(IsNull(b.ylnumi), 0, b.ylnumi) as ylnumi, a.yfcprod, a.yfcdprod1, IIf(IsNull(b.ylpvenmay), 0, b.ylpvenmay) as ylpvenmay, IIf(IsNull(b.ylpventaul), 0, b.ylpventaul) as ylpventaul, IIf(IsNull(b.ylpcostoul), 0, b.ylpcostoul) as ylpcostoul, b.ylpdol  
        'FROM TY005 a left join (Select * From TY0052 where ylalm = 3) b on a.yfcprod = b.ylcprod  
        'WHERE b.ylcprod is null
