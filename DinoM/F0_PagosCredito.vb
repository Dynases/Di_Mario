    ...
    Private Sub tbcobrador_KeyDown(sender As Object, e As KeyEventArgs) Handles tbcobrador.KeyDown
        If (_fnAccesible()) Then
            If e.KeyData = Keys.Control + Keys.Enter Then
                ...
                listEstCeldas.Add(New Modelo.Celda("ydcod", True, "ID", 150))
        ...
        If (e.KeyData = Keys.Enter) Then
            ...
            If (f >= 0) Then
                ...
                If ((pos >= 0) And (Not existe)) Then
                    ...
                    CType(grfactura.DataSource, DataTable).Rows(pos).Item("cliente") = grPendiente.GetValue("ydcod") + "-" + grPendiente.GetValue("cliente")
